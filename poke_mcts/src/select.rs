...
pub fn select_arm(bandit: &Bandit, parent_visits: u32) -> usize {
    ...
    for i in 0..bandit.len as usize {
        ...
        let v = a.total_score / a.visits as f64 + (2.0 * ln_n / a.visits as f64).sqrt();
